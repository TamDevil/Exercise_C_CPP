...
// Task để khởi tạo và cập nhật hệ thống kiểm soát lực kéo
void* Task_TractionControl(void* arg) {
    // Gọi hàm khởi tạo Traction Control
    TractionControl_Init();

    // Liên tục cập nhật hệ thống kiểm soát lực kéo
    while (1) {
...
int main(void) {
    ...
    // Tạo task chung cho Traction Control (khởi tạo + cập nhật)
