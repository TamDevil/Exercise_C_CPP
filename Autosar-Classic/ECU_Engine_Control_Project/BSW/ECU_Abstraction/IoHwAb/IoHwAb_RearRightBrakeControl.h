#ifndef IOHWAB_REARRIGHTBRAKECONTROL_H
#define IOHWAB_REARRIGHTBRAKECONTROL_H

#include "Std_Types.h"

/**
 * @brief   Cấu hình cho bộ điều khiển phanh bánh sau phải.
...
} RearRightBrakeDriver_ConfigType;
...
/**
 * @brief   Điều chỉnh lực phanh bánh sau phải.
 * @details Hàm này thiết lập giá trị lực phanh mong muốn cho bánh trước trái.
...
#endif /* IOHWAB_REARRIGHTBRAKECONTROL_H */
