#ifndef IOHWAB_REARRIGHTWHEELSPEEDSENSOR_H
#define IOHWAB_REARRIGHTWHEELSPEEDSENSOR_H

#include "Std_Types.h"


/**
 * @brief   Cấu hình cho cảm biến tốc độ bánh sau phải.
...
} RearRightSpeedSensor_ConfigType;
...
/**
 * @brief   Đọc giá trị tốc độ từ cảm biến bánh sau phải.
 * @details Hàm này lấy dữ liệu từ cảm biến tốc độ bánh sau phải và trả về
...
#endif /* IOHWAB_REARRIGHTWHEELSPEEDSENSOR_H */
