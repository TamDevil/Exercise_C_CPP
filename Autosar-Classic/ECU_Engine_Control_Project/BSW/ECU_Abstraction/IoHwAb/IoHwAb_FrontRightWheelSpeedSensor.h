#ifndef IOHWAB_FRONTRIGHTWHEELSPEEDSENSOR_H
#define IOHWAB_FRONTRIGHTWHEELSPEEDSENSOR_H

#include "Std_Types.h"


/**
 * @brief   Cấu hình cho cảm biến tốc độ bánh trước phải.
...
} FrontRightSpeedSensor_ConfigType;
...
/**
 * @brief   Đọc giá trị tốc độ từ cảm biến bánh trước phải.
 * @details Hàm này lấy dữ liệu từ cảm biến tốc độ bánh trước phải và trả về
...
#endif /* IOHWAB_FRONTRIGHTWHEELSPEEDSENSOR_H */
