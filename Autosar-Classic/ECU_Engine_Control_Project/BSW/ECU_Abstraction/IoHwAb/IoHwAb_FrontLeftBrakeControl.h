#ifndef IOHWAB_FRONTLEFTBRAKECONTROL_H
#define IOHWAB_FRONTLEFTBRAKECONTROL_H

#include "Std_Types.h"

/**
 * @brief   Cấu hình cho bộ điều khiển phanh bánh trước trái.
...
} FrontLeftBrakeDriver_ConfigType;
...
/**
 * @brief   Điều chỉnh lực phanh bánh trước trái.
...
#endif /* IOHWAB_FRONTLEFTBRAKECONTROL_H */
