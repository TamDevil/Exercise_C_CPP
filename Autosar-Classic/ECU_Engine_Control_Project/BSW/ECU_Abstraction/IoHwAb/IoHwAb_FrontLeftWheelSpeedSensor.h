#ifndef IOHWAB_FRONTLEFTWHEELSPEEDSENSOR_H
#define IOHWAB_FRONTLEFTWHEELSPEEDSENSOR_H

#include "Std_Types.h"


/**
 * @brief   Cấu hình cho cảm biến tốc độ bánh trước trái.
...
} FrontLeftSpeedSensor_ConfigType;
...
/**
 * @brief   Đọc giá trị tốc độ từ cảm biến bánh trước trái.
 * @details Hàm này lấy dữ liệu từ cảm biến tốc độ bánh trước trái và trả về
...
#endif /* IOHWAB_FRONTLEFTWHEELSPEEDSENSOR_H */
